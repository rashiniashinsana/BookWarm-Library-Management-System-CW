...
public class AdminNavigationController {
    ...
    void btnLogoutOnAction(MouseEvent event) throws IOException {
        NavigationPane.getChildren().clear();
        NavigationPane.getChildren().add(FXMLLoader.load(this.getClass().getResource("/view/admin/adminNavigationForm.fxml")));
    }
    ...
    void btnBookManagementOnAction(MouseEvent event) throws IOException {
        ...
        NavigationPane.getChildren().clear();
        NavigationPane.getChildren().add(FXMLLoader.load(this.getClass().getResource("/view/admin/adminBookManageForm.fxml")));
    }
